...
while True:
    ...
    circles = cv2.HoughCircles(frame1,cv2.HOUGH_GRADIENT,1,20,param1=30,param2=70,minRadius=0,maxRadius=100)
    if circles is not None: # 원 검출
        ...
        for i in circles[0,:]:
            ...
            result_blue = cv2.bitwise_and(hsv, hsv, mask=mask_blue) #파란색 검출
